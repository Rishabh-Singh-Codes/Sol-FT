...
// type Props = {
//   title: string;
//   method: (pageParam?: string) => {nfts?: Collection, next: string, collections?: Collection};
// }

// const InfiniteScrollCards = ({title, method}: Props) => {
//   const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
//     useInfiniteQuery(
//       "getCollections",
//       ({ pageParam = undefined }) => method(pageParam),
//       {
